...
export const AVATAR_FRAMES: Record<string, AvatarFrameConfig> = {
  ...
  'fuffy': {
    ...
    animationType: 'float',
    imageUrl: '/images/frames/fuffy_frame.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  },
  'fuffy_frame': {
  ...
  'sea_sands': {
    ...
    animationType: 'flow',
    imageUrl: '/images/frames/sea_sands_frame.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  },
  'sea_sands_frame': {
  ...
  'basra': {
    ...
    animationType: 'pulse',
    imageUrl: '/images/frames/basra_frame.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  },
  'basra_frame': {
  ...
  'butterflies': {
    ...
    animationType: 'sparkle',
    imageUrl: '/images/frames/butterflies_frame.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  },
  'butterflies_frame': {
    id: 'butterflies_frame',
    name: 'Butterflies',
    tier: 'legendary',
    price: 350000,
    gradient: 'transparent',
  ...
  'top3family_topuser': {
    id: 'top3family_topuser',
    name: 'Top 3 Family User',
    tier: 'mythic',
    price: 400000,
    gradient: 'transparent',
    borderColor: 'transparent',
    ...
    animationType: 'rotate',
    imageUrl: '/images/frames/top3family_topuser.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  },
  'top2family_topuser': {
    id: 'top2family_topuser',
    name: 'Top 2 Family User',
    tier: 'mythic',
    price: 450000,
    gradient: 'transparent',
    borderColor: 'transparent',
    ...
    animationType: 'rotate',
    imageUrl: '/images/frames/top2family_topuser.png',
    scaleMultiplier: 1.15,
    holeRatio: 0.65
  }
};

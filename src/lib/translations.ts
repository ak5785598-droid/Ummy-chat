...
export const TRANSLATIONS: Record<LanguageCode, any> = {
  en: {
    ...
    home: { recommend: 'Recommend', mine: 'Me', categories: { all: 'All', chat: 'Chat', games: 'Games', newcomers: 'Newcomers', party: 'Party' }, topRooms: 'Top Rooms Grid', launch: 'Launch Frequency', noActive: 'No Active Frequencies' },
    profile: { fans: 'Fans', following: 'Following', friends: 'Friend', visitors: 'Visitors', coins: 'Coins', diamonds: 'Diamonds', level: 'Level', store: 'Store', budget: 'Budget', task: 'Task', vip: 'Vip Premium™', secretCard: 'Secret card get rewards', invite: 'Invite friends', bag: 'Bag', inventory: 'Inventory', cp: 'Cp/friends', help: 'Help center', about: 'About', settings: 'Setting', id: 'ID', follow: 'Follow', chat: 'Chat' },
  ...
  hi: {
    ...
    home: { recommend: 'अनुशंसित', mine: 'मेरी', categories: { all: 'सभी', chat: 'चैट', games: 'गेम', newcomers: 'नवागंतुक', party: 'पार्टी' }, topRooms: 'टॉप रूम ग्रिड', launch: 'फ्रीक्वेंसी शुरू करें', noActive: 'कोई सक्रिय फ्रीक्वेंसी नहीं' },
  ...
  bn: {
    ...
    home: { recommend: 'প্রস্তাবিত', mine: 'আমার', categories: { all: 'সব', chat: 'চ্যাট', games: 'গেম', newcomers: 'নতুন', party: 'পার্টি' }, topRooms: 'টপ রুম গ্রিড', launch: 'ফ্রিকোয়েন্সি শুরু করুন', noActive: 'কোনো সক্রিয় ফ্রিকোয়েন্সি নেই' },
  ...
  ar: {
    ...
    home: { recommend: 'موصى به', mine: 'غرفتي', categories: { all: 'الكل', chat: 'دردشة', games: 'ألعاب', newcomers: 'القادمون الجدد', party: 'حفلة' }, topRooms: 'أعلى الغرف', launch: 'بدء التردد', noActive: 'لا يوجد ترددات نشطة' },
  ...
  ur: {
    ...
    home: { recommend: 'تجویز کردہ', mine: 'میری', categories: { all: 'تمام', chat: 'چیٹ', games: 'گیمز', newcomers: 'نئے آنے والے', party: 'پارٹی' }, topRooms: 'ٹاپ رومز', launch: 'فریکوئنسی شروع کریں', noActive: 'کوئی فعال فریکوئنسی نہیں' },

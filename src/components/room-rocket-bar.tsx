...
// --- 1. YE HAI VO BLUE ROCKET JO SCREEN PAR DIKHEGA ---
const MiniBlueRocket = ({ className }: { className?: string }) => (
  <svg 
    viewBox="0 0 100 120" 
    fill="none" 
    xmlns="http://www.w3.org/2000/svg" 
    className={cn("drop-shadow-[0_0_8px_rgba(56,189,248,0.8)]", className)}
  >
    <path d="M25 70 Q15 80 20 100 L35 100 Q40 80 35 70 Z" fill="url(#miniBlue)" stroke="#FFD700" strokeWidth="1"/>
    <path d="M75 70 Q85 80 80 100 L65 100 Q60 80 65 70 Z" fill="url(#miniBlue)" stroke="#FFD700" strokeWidth="1"/>
    <path d="M50 10 C30 40 30 80 35 105 L65 105 C70 80 70 40 50 10 Z" fill="url(#miniBlue)" stroke="#FFD700" strokeWidth="1.5"/>
    <circle cx="50" cy="50" r="8" fill="#000" stroke="#FFD700" strokeWidth="1"/>
    <defs>
      <linearGradient id="miniBlue" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <div className="relative">
          <svg className="w-12 h-12 -rotate-90">
            ...
            <motion.circle
              ...
              className={cn("transition-all duration-500", progressPercent >= 100 ? "stroke-yellow-400 shadow-[0_0_8px_yellow]" : "stroke-blue-400")}
              strokeWidth="3"
          ...
          {/* ICON REPLACEMENT - Yahan change kiya hai */}
          <div className="absolute inset-0 flex items-center justify-center p-1.5">
              <MiniBlueRocket className={cn(
                "h-8 w-8",
                progressPercent >= 100 ? "animate-bounce" : "opacity-100"
              )} />
          </div>
        ...
        {showFlight && (
          <motion.div className="fixed inset-0 z-[100] pointer-events-none">
            ...
            >
              ...
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-4 h-16 bg-blue-400/50 blur-lg rounded-full animate-pulse" />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>

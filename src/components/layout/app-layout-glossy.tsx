  ...
  <SidebarProvider defaultOpen={!deterministicAuth}>
    ...
    <SidebarInset className={cn(
      ...
      {!deterministicAuth && !hideBottomNav && isMainTab && (
        ...
        >
          <div className="flex items-center justify-around bg-white/80 backdrop-blur-xl h-14 border-t border-white/40 shadow-[0_-5px_25px_rgba(0,0,0,0.03)] transition-all">

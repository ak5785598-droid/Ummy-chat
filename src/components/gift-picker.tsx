...
const GIFTS: Record<string, GiftItem[]> = {
 'Hot': [
  { id: 'choco_pops', name: 'Choco Pops', price: 25, icon: '🍭', animationId: 'choco-pops' },
  { id: 'chai', name: 'Chai', price: 75, icon: '☕', animationId: 'chai' },
  { id: 'rose', name: 'Rose', price: 145, icon: '🌹', animationId: 'rose' },
  { id: 'applaud', name: 'Applaud', price: 500, icon: '👏', animationId: 'applaud' },
  { id: 'love_bomb', name: 'Love Bomb', price: 1249, icon: '💣', animationId: 'love-bomb' },
  { id: 'kiss', name: 'Kiss', price: 2499, icon: '💋', animationId: 'kiss' },
  { id: 'chocolate_box', name: 'Choco Box', price: 3000, icon: '🍫', animationId: 'chocolate-box' },
  { id: 'money_gun', name: 'Money Gun', price: 7000, icon: '🔫', animationId: 'money-gun' },
  { id: 'watch', name: 'Watch', price: 9499, icon: '⌚', animationId: 'watch' },
  { id: 'birthday_cake', name: 'Birthday Cake', price: 10000, icon: '🎂', animationId: 'birthday-cake' },
  ...
  { id: 'soccer_ball', name: 'Soccer Ball', price: 50, icon: '⚽', animationId: 'soccer-ball' },
  ...
  { id: 'doughnut', name: 'Doughnut', price: 90, icon: '🍩', animationId: 'doughnut' },
  { id: 'candy', name: 'Candy', price: 30, icon: '🍬', animationId: 'candy' },
  ...
  { id: 'coffee', name: 'Coffee', price: 60, icon: '☕', animationId: 'coffee' },
  { id: 'tea', name: 'Tea', price: 50, icon: '🍵', animationId: 'tea' },
  { id: 'milk', name: 'Milk', price: 40, icon: '🥛', animationId: 'milk' },
  { id: 'cookie', name: 'Cookie', price: 20, icon: '🍪', animationId: 'cookie' },
  { id: 'apple', name: 'Apple', price: 10, icon: '🍎', animationId: 'apple' },
  { id: 'banana', name: 'Banana', price: 15, icon: '🍌', animationId: 'banana' },
  { id: 'cherry', name: 'Cherry', price: 80, icon: '🍒', animationId: 'cherry' },
  { id: 'peach', name: 'Peach', price: 100, icon: '🍑', animationId: 'peach' },
  ...
  { id: 'lemon', name: 'Lemon', price: 70, icon: '🍋', animationId: 'lemon' },

...
export function RoomInfoDialog({ open, onOpenChange, room, isOwner, isAdmin }: RoomInfoDialogProps) {
 ...
 return (
  <Dialog open={open} onOpenChange={onOpenChange}>
   <DialogContent hideClose={true} className="max-w-full sm:max-w-md bg-white text-black p-0 pb-safe pb-4 rounded-t-[2.5rem] border-none shadow-2xl overflow-hidden font-sans bottom-0 top-auto fixed translate-y-0 animate-in slide-in-from-bottom duration-500">

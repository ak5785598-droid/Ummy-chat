 ...
 const handlePlayDeviceTrack = (file: File) => {
  ...
  const gameGrid = [
    ...
    { 
      ...
      disabled: true, // DISABLED: Temporarily disabled
    },
  ];
      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center pointer-events-none">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-[500px] bg-[#121212] rounded-t-[2rem] border-t border-white/10 shadow-2xl pointer-events-auto overflow-hidden flex flex-col mb-0 pb-safe pb-4"
            style={{ 

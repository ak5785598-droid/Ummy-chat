...
export function RoomPlayDialog({ 
 ...
 const handlePlayDeviceTrack = (file: File) => {
  ...
  const gameGrid = [
    ...
    { id: 'voice-off',  label: room?.isVoiceMuted ? 'Voice Off' : 'Voice On', icon: '/images/premium_3d_microphone_icon_1775544232062.png', color: room?.isVoiceMuted  ? 'from-red-500/20 to-red-700/20' : 'from-green-500/20 to-emerald-600/20', onClick: handleToggleVoice }, 
  ] ;
  return (
    <AnimatePresence>
      {open && (

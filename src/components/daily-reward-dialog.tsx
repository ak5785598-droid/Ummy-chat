    ...
    <div className="relative bg-[#fffdf0] rounded-[3rem] p-6 pt-12 shadow-2xl animate-in zoom-in duration-500 border-4 border-white">
     ...
     <div className="flex justify-center pb-4">
      <Button 
       ...
       className="w-full h-16 rounded-2xl bg-gradient-to-b from-yellow-300 via-yellow-400 to-yellow-500 text-green-900 font-bold text-2xl uppercase shadow-[0_10px_30px_rgba(234,179,8,0.4)] border-b-4 border-yellow-600 hover:scale-[1.02] active:scale-95 transition-all"
      >

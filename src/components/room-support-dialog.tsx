...
const GOALS_REWARDS = [
  { level: 17, visitors: '≥1.4K', roomCoins: '≥2600M', totalCoins: '250,960,000', hostCoins: '152,200,000', partnerCoins: '8,230,000', partners: 12 },
  { level: 16, visitors: '≥1.2K', roomCoins: '≥1900M', totalCoins: '187,150,000', hostCoins: '100,750,000', partnerCoins: '7,200,000', partners: 12 },
  { level: 15, visitors: '≥1K', roomCoins: '≥1300M', totalCoins: '131,580,000', hostCoins: '77,350,000', partnerCoins: '4,930,000', partners: 11 },
  { level: 14, visitors: '≥800', roomCoins: '≥800M', totalCoins: '82,250,000', hostCoins: '45,250,000', partnerCoins: '3,700,000', partners: 10 },
  { level: 13, visitors: '≥600', roomCoins: '≥600M', totalCoins: '61,670,000', hostCoins: '33,950,000', partnerCoins: '3,080,000', partners: 9 },
  { level: 12, visitors: '≥500', roomCoins: '≥400M', totalCoins: '41,160,000', hostCoins: '21,400,000', partnerCoins: '2,470,000', partners: 8 },
  { level: 11, visitors: '≥450', roomCoins: '≥300M', totalCoins: '30,850,000', hostCoins: '17,900,000', partnerCoins: '1,850,000', partners: 7 },
  { level: 10, visitors: '≥400', roomCoins: '≥200M', totalCoins: '20,530,000', hostCoins: '13,150,000', partnerCoins: '1,230,000', partners: 6 },
  { level: 9, visitors: '≥350', roomCoins: '≥150M', totalCoins: '15,650,000', hostCoins: '10,300,000', partnerCoins: '1,070,000', partners: 5 },
  { level: 1, visitors: '≥20', roomCoins: '≥5M', totalCoins: '600,000', hostCoins: '450,000', partnerCoins: '150,000', partners: 1 },
];
                ...
                <table className="w-full text-[11px] font-bold">
                  <thead className="bg-blue-900/40 border-b border-blue-800/50">
                    <tr className="text-blue-300/70">
                      <th className="py-3 px-2 text-left font-black uppercase tracking-tighter">Period</th>
                      <th className="py-3 px-2 text-center font-black uppercase tracking-tighter">Level</th>
                      <th className="py-3 px-2 text-center font-black uppercase tracking-tighter">Rewards</th>
                      <th className="py-3 px-2 text-center font-black uppercase tracking-tighter">Visitors</th>
                      <th className="py-3 px-2 text-right font-black uppercase tracking-tighter">Coins</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-white/5 bg-blue-500/5">
                      <td className="py-4 px-2 text-blue-400">This Week</td>
                      <td className="py-4 px-2 text-center">{roomLevel}</td>
                      <td className="py-4 px-2 text-center text-yellow-400">0</td>
                      <td className="py-4 px-2 text-center">{visitorCount}</td>
                      <td className="py-4 px-2 text-right text-cyan-400">{roomCoins}</td>
                    </tr>
                    <tr className="bg-white/5 opacity-50">
                      <td className="py-4 px-2 text-white/40">Last Week</td>
                      <td className="py-4 px-2 text-center">0</td>
                      <td className="py-4 px-2 text-center italic">--</td>
                      <td className="py-4 px-2 text-center">0</td>
                      <td className="py-4 px-2 text-right">0</td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <table className="w-full text-[10px] font-bold">
                    <thead className="bg-[#1a253a] border-b border-white/5 text-center">
                      <tr className="text-white/40">
                        <th className="py-4 px-2" rowSpan={2}>Level</th>
                        <th className="py-2 px-2 border-b border-white/5" colSpan={2}>Goals</th>
                        <th className="py-2 px-2 border-b border-white/5" colSpan={4}>Rewards</th>
                      </tr>
                      <tr className="text-white/60">
                        <th className="py-3 px-2 border-r border-white/5">Visitors</th>
                        <th className="py-3 px-2 border-r border-white/5">Room Coins</th>
                        <th className="py-3 px-2 border-r border-white/5">Total Coins</th>
                        <th className="py-3 px-2 border-r border-white/5 text-yellow-400">Host Coins</th>
                        <th className="py-3 px-2 border-r border-white/5">Partner</th>
                        <th className="py-3 px-2">Partners</th>
                      </tr>
                    </thead>
                    <tbody>
                      {GOALS_REWARDS.map((goal, idx) => (
                        <tr key={idx} className={cn("text-center border-b border-white/5", idx % 2 === 0 ? "bg-white/[0.02]" : "bg-transparent")}>
                          <td className="py-3 font-black text-blue-400">{goal.level}</td>
                          <td className="py-3 px-1 border-r border-white/5">{goal.visitors}</td>
                          <td className="py-3 px-1 border-r border-white/5 text-cyan-400">{goal.roomCoins}</td>
                          <td className="py-3 px-1 border-r border-white/5 text-white/70">{goal.totalCoins}</td>
                          <td className="py-3 px-1 border-r border-white/5 text-yellow-400">{goal.hostCoins}</td>
                          <td className="py-3 px-1 border-r border-white/5 text-blue-300">{goal.partnerCoins}</td>
                          <td className="py-3 px-1">{goal.partners}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>

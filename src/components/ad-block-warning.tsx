...
export function AdBlockWarning() {
  ...
  return (
    <div className="fixed top-6 left-4 right-4 z-[9999] animate-in slide-in-from-top-10 duration-700 font-headline">
      <div className="bg-red-600 text-white rounded-3xl p-5 shadow-[0_20px_50px_rgba(220,38,38,0.4)] border-2 border-white/20 flex items-center justify-between gap-4 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
           ...
           <div className="space-y-0.5">
              <h4 className="font-black uppercase italic tracking-tighter text-lg leading-tight">Frequency Blocked</h4>

     ...
     <div className="bg-black/60 backdrop-blur-xl rounded-[calc(1rem-2px)] px-4 py-3 flex items-center justify-between overflow-hidden relative">
      ...
      <div className="flex items-center gap-3 relative z-10">
        ...
        <div className="min-w-0">
         <p className="text-[8px] font-bold uppercase text-yellow-400 tracking-wider leading-none mb-1 flex items-center gap-1">
          <Zap className="h-2 w-2 fill-current" /> Lucky Bag Broadcast
         </p>
         <h4 className="text-[11px] font-bold text-white uppercase tracking-tight truncate w-40 sm:w-64">
           {activeBroadcast.senderName} sent a Bag in Room #{activeBroadcast.roomNumber}
         </h4>
        </div>
      </div>

      <div className="flex items-center gap-2 bg-yellow-400 text-black px-4 py-1.5 rounded-full font-bold uppercase text-[9px] shadow-lg group-hover:scale-105 transition-transform shrink-0 relative z-10">

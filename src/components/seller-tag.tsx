...
export function SellerTag({ className, size = 'md' }: { className?: string, size?: 'sm' | 'md' | 'lg' }) {
 ...
 return (
  <div className={cn("relative inline-flex items-center justify-center select-none group", className)} style={{ transform: `scale(${scale})`, transformOrigin: 'left center' }}>
   ...
   {/* Main Tag Container */}
   <div className={cn(
    "relative flex items-center gap-2 pl-1 pr-4 py-0.5 bg-gradient-to-b from-[#d946ef] via-[#9333ea] to-[#581c87] rounded-[0.5rem] border-[3px] border-[#f472b6] shadow-[0_0_15px_rgba(244,114,182,0.6),inset_0_2px_4px_rgba(255,255,255,0.3)] overflow-hidden",

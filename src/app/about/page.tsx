...
export default function AboutPage() {
  ...
  return (
    <AppLayout hideSidebarOnMobile hideBottomNav>
      <div className="min-h-full bg-white font-headline flex flex-col animate-in fade-in duration-700 overflow-hidden relative">
        
        {/* Ambient Top Gradient Sync (Mint/Green vibe from reference) */}
        <div className="absolute top-0 left-0 right-0 h-[40vh] bg-gradient-to-b from-[#e8f5e9] via-[#f1f8e9] to-transparent opacity-80" />
        ...
        <main className="relative z-50 flex-1 px-6 mt-4">
           <Card className="rounded-[2.5rem] bg-white border-none shadow-[0_20px_50px_rgba(0,0,0,0.04)] overflow-hidden flex flex-col items-center">
              <div className="pt-14 pb-16 flex flex-col items-center gap-4">
              ...
              <div className="w-full">
                 <button 
                   ...
                   className="w-full flex items-center justify-between p-10 hover:bg-gray-50 active:bg-gray-100 transition-all text-left group"
                 >

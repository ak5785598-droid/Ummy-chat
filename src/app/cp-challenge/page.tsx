...
export default function CpChallengePage() {
 ...
 return (
  <AppLayout fullScreen>
   <div className="h-[100dvh] w-full bg-[#800020] flex flex-col relative overflow-hidden font-sans text-white select-none">
    <header className="relative z-50 flex items-center justify-between p-6 pt-12">
      ...
      <h1 className="text-2xl font-bold uppercase tracking-tight">Couple Challenge</h1>
    ...
    <ScrollArea className="flex-1">
      <div className="relative h-[55vh] flex flex-col items-center justify-center">
       ...
       <div className="relative z-10 text-center animate-pulse">
         ...
         <p className="text-xl font-bold uppercase tracking-wider">Awaiting Ranking Sync</p>
       </div>
      </div>
    </ScrollArea>
   </div>

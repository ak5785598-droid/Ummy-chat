        ...
        <div className="w-full rounded-3xl bg-white/10 border border-white/20 backdrop-blur-xl shadow-2xl p-6 space-y-6 text-center">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full h-12 rounded-full bg-[#1877F2] hover:bg-[#166FE5] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-base shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              Continue with Facebook
            </button>

            <div id="google-gsi-button" className="w-full flex justify-center h-12 overflow-hidden" />
          </div>
          ...
          <button
            ...
            className="w-full h-12 rounded-full bg-white/20 text-white border border-white/30 font-bold hover:bg-white/30 transition-all active:scale-95 flex items-center justify-center gap-2"
          >

...
import { Card, Cardontent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
...
const ACTIVE_GAME_FREQUENCIES = [
  { id: 'carrom', title: 'Carrom Masters', slug: 'carrom', imageHint: 'carrom board game' },

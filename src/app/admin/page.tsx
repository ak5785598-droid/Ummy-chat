               ...
               <Card className="rounded-[2.5rem] border-none shadow-xl p-8 bg-white">
                  ...
                  <div className="flex flex-col gap-4">
                     ...
                     <div className="flex gap-4">
                        ...
                        <Button onClick={() => handleGenericSearch('name', dmSearchName, setTargetUserForDm, setIsSearchingDm)} className="h-14 px-8 rounded-2xl bg-slate-100 text-slate-900 border-2 border-slate-200 font-black uppercase italic" disabled={isSearchingCenter}>Find Name</Button>
                     </div>
                  </div>

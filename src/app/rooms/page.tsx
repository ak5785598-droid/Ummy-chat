      ...
      <>
       ...
       >
        ...
        <div className="px-3 mb-3">
          <div className="bg-gradient-to-r from-red-600 via-rose-700 to-red-800 backdrop-blur-3xl rounded-[1.5rem] p-3 border-2 border-white/10 shadow-2xl overflow-hidden relative group h-[80px]">

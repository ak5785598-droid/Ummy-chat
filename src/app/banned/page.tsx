...
export default function BannedPage() {
 ...
 return (
  <div className="h-screen w-full bg-[#0a0a0a] flex flex-col items-center justify-center p-8 font-sans text-white overflow-hidden relative">
   {/* Background Radiance */}
   ...
   <div className="relative z-10 flex flex-col items-center text-center max-w-sm w-full space-y-10 animate-in fade-in zoom-in duration-1000">
     <div className="relative">
      ...
      <div className="h-24 w-32 rounded-[3rem] bg-gradient-to-br from-red-600 to-red-950 flex items-center justify-center border-4 border-white/5 shadow-[0_0_50px_rgba(220,38,38,0.3)] relative z-10">
     ...
     <div className="w-full p-6 bg-white/5 backdrop-blur-xl rounded-2xl border-2 border-white/5 shadow-2xl space-y-6">
      ...
      <div className="space-y-2">
        <p className="text-[10px] font-bold text-white/40 uppercase tracking-wider text-left ml-1">Restricted Member</p>
     ...
     <Button 
      ...
      variant="outline" 
      className="w-full h-16 rounded-xl bg-white/5 border-white/10 text-white font-bold uppercase text-lg shadow-xl hover:bg-white/10"
     >
      <LogOut className="mr-2 h-6 w-6" /> Exit Portal
     </Button>

     <p className="text-[8px] font-bold uppercase tracking-[0.5em] text-white/20">Ummy Sovereign Defense System Synchronized</p>
   </div>
  </div>
 );
}

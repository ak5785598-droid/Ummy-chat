...
function InviteFriendsDialog({ open, setOpen }: { open: boolean, setOpen: (o: boolean) => void }) {
  ...
  const handleShare = (platform: 'whatsapp' | 'facebook') => {
    ...
    if (platform === 'whatsapp') {
      ...
      url = `https://www.facebook.com/sharer/sharer.php?u=${inviteLink}`;
    }
    ...
    setTimeout(() => {
      ...
      addDocumentNonBlocking(notifRef, {
        title: 'Invite Reward',
        content: `Notice.. You receive ${reward.toLocaleString()} coins for sharing the tribe link..... Best regard Ummy official`,
        type: 'system',
      ...
      toast({
        ...
        description: `Synced ${reward.toLocaleString()} Gold Coins for growing the tribe.`
      });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[425px] bg-white text-black p-0 rounded-t-[3rem] overflow-hidden border-none shadow-2xl">
        ...
        <div className="p-8 space-y-8">
           ...
           <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-2xl border-2 border-gray-100">
                 ...
                 <button 
                   ...
                   className="p-2 bg-white rounded-xl shadow-sm text-primary hover:scale-110 transition-transform"
                 >
           ...
           <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                className="flex flex-col items-center gap-2 p-4 bg-[#25D366]/10 border-2 border-[#25D366]/20 rounded-[2rem] hover:bg-[#25D366]/20 transition-all group active:scale-95"
              >
                 <div className="h-12 w-12 bg-[#25D366] rounded-2xl flex items-center justify-center shadow-lg shadow-[#25D366]/20">
              ...
              <button 
                ...
                className="flex flex-col items-center gap-2 p-4 bg-[#1877F2]/10 border-2 border-[#1877F2]/20 rounded-[2rem] hover:bg-[#1877F2]/20 transition-all group active:scale-95"
              >
                 <div className="h-12 w-12 bg-[#1877F2] rounded-2xl flex items-center justify-center shadow-lg shadow-[#1877F2]/20">
                    <span className="text-white text-2xl">👥</span>
                 </div>
        ...
        <footer className="p-8 pt-0 text-center">
           <p className="text-[8px] text-muted-foreground uppercase font-black tracking-[0.2em] italic">
              Rewards are distributed atomically upon link broadcast.
           </p>
        </footer>
      </DialogContent>
    </Dialog>

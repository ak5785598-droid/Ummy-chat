...
export default function CarromGamePage() {
 ...
 if (isLaunching) {
  ...
  return (
   <div 
    className="h-screen w-full bg-[#004d40] flex flex-col items-center justify-center space-y-6 font-sans relative overflow-hidden"
   ...
   >
    ...
    <div className="relative z-10 flex flex-col items-center justify-center space-y-6">
      ...
      <h1 className="text-6xl font-bold text-[#fbc02d] uppercase tracking-tight drop-shadow-2xl">Carrom Master</h1>
      <p className="text-white/40 uppercase tracking-wider text-[10px] animate-pulse">Synchronizing Board...</p>
    </div>
   </div>
  );
 }
  ...
  <AppLayout fullScreen>
   <div className="h-screen w-full bg-gradient-to-b from-[#00838f] to-[#004d40] flex flex-col relative overflow-hidden font-sans text-white">
    ...
    <header className="relative z-50 flex items-center justify-between p-4 pt-32">
      ...
      <h1 className="text-2xl font-bold text-white uppercase tracking-tight drop-shadow-md">Carrom</h1>
    ...
    <main className="flex-1 flex flex-col items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[380px] aspect-square bg-[#f5ba78] rounded-2xl border-[12px] border-[#004d40] shadow-[0_30px_60px_rgba(0,0,0,0.5)] flex items-center justify-center p-4">
       ...
       <div className="relative w-32 h-24 rounded-full border-2 border-[#8d6e63]/40 flex items-center justify-center">

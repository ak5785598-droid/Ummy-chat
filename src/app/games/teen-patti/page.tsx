...
export default function TeenPattiGamePage() {
 ...
 if (isLaunching) return <div className="h-screen w-full bg-[#1a0a2e] flex flex-col items-center justify-center space-y-6"><UmmyLogoIcon className="h-20 w-20 animate-bounce" /><h1 className="text-5xl font-bold text-yellow-500 uppercase tracking-tight">Teen Patti</h1></div>;

 const winnerBanner = winnerId ? FACTIONS.find(f => f.id === winnerId)?.bannerUrl : null;

 return (
  <AppLayout fullScreen>
   <div className="h-[100dvh] w-full bg-[#581c87] flex flex-col relative overflow-hidden font-sans text-white">
    <CompactRoomView />
    ...
    <header className="relative z-[110] flex items-center justify-between p-4 pt-32">
      ...
      <div className="flex flex-col items-center">
       <h1 className="text-5xl font-bold uppercase tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white via-[#ffd700] to-[#b8860b] filter drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">TEEN PATTI</h1>

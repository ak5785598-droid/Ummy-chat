...
export default function CpHousePage() {
 ...
 return (
  <AppLayout fullScreen>
   <div className="h-[100dvh] w-full bg-[#fce4ec] flex flex-col relative overflow-hidden font-sans text-white select-none">
    <header className="relative z-50 flex items-center justify-between p-6 pt-12">
      ...
      <h1 className="text-2xl font-bold uppercase tracking-tight">Love house</h1>
    ...
    <main className="relative z-10 flex-1 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-6">
       ...
       <h2 className="text-3xl font-bold uppercase text-pink-600">Partner Frequency</h2>
       <Button className="bg-pink-500 rounded-full h-14 px-10 font-bold uppercase shadow-xl">Connect Partner</Button>
      </div>
    </main>
   </div>
  </AppLayout>

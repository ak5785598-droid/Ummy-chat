 ...
 return (
  <AppLayout>
   <div className="max-w-4xl mx-auto p-8 font-body text-white/80 space-y-6 pt-32 pb-32">
    <h1 className="text-4xl font-bold text-white uppercase tracking-tight drop-shadow-lg">Terms of Service</h1>
    ...
    <section className="space-y-4 bg-white/5 p-6 rounded-2xl border border-white/10">
     <h2 className="text-2xl font-bold text-yellow-400 uppercase ">1. Acceptance of Terms</h2>
     ...
     <h2 className="text-2xl font-bold text-yellow-400 uppercase mt-6">2. Rules of Conduct</h2>
     ...
     <h2 className="text-2xl font-bold text-yellow-400 uppercase mt-6">3. Disclaimer</h2>

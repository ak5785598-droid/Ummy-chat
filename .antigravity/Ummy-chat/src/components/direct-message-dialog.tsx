   ...
   <DialogContent className="sm:max-w-[425px] rounded-t-[2.5rem] border-none shadow-2xl bg-white text-black p-0 overflow-hidden animate-in slide-in-from-bottom-full duration-500">
    <DialogHeader className="p-8 pb-4 border-b border-gray-50 flex flex-row items-center gap-4">
     ...
     <div className="flex-1 text-left">
      <DialogTitle className="text-xl font-bold uppercase tracking-tight">Sync Message</DialogTitle>
      <DialogDescription className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground mt-1">To: {recipient.username}</DialogDescription>
     </div>
    </DialogHeader>
    <div className="p-8 space-y-6">
     <Textarea 
      ...
      className="resize-none h-24 rounded-xl border-2 border-yellow-200 bg-yellow-50 focus:border-primary transition-all p-4 text-sm font-body placeholder:text-yellow-600/40 text-yellow-900"

   ...
   <div className="flex items-center justify-between p-3 pointer-events-auto">
    <div className="flex items-center gap-3">
     ...
     <div className="flex items-center gap-3">
      ...
      <div>
       <h2 className="text-xs font-bold uppercase text-white truncate w-32 leading-none mb-1">{activeRoom.title}</h2>
    ...
    <Badge variant="outline" className="text-[8px] border-primary/20 text-primary uppercase font-bold px-2 py-0">Live Frequency</Badge>
   </div>
  </div>
 );
}
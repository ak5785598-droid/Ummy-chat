    ...
    <AppLayout>
      <div className="flex flex-col items-center justify-center h-[70vh] space-y-6 text-center px-8 font-headline animate-in fade-in duration-1000 bg-white">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-black uppercase italic tracking-tighter">Messages Dimension</h1>
          <p className="text-muted-foreground font-body text-lg italic">Your tribal inbox is synchronizing...</p>
        </div>
        <div className="flex items-center gap-3 bg-secondary/50 px-6 py-3 rounded-2xl border border-gray-100 shadow-inner">
           ...
           <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Loading Frequencies</span>
        </div>
      </div>
    </AppLayout>
  );

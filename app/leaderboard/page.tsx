...
const RankingCountdown = () => {
  ...
  useEffect(() => {
    const updateCountdown = () => {
      ...
      // Calculate target: Today at 23:59:59 IST
      const target = new Date(istTimeStr);
  ...
  return (
    <div className="mt-8 mb-4 flex flex-col items-center gap-1.5 animate-in fade-in slide-in-from-top-2 duration-1000">
       ...
       <span className="text-2xl font-black text-white italic drop-shadow-lg tabular-nums tracking-tighter">{timeLeft}</span>
    </div>
  );
};
